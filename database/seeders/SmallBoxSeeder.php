...
class SmallBoxSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $spents = array(
            ...
            (object)[
                'concept' => "LICENCIAS DE FUNCIONAMIENTO",
                'center_id' => 21,
                'outgo_type' => "VARIABLE",
                'expense_type' => "GASTO",
                'product_type' => "SERVICIO",
            ...
            (object)[
                'concept' => "TRÁMITES VEHICULARES (PERMISO DE CARGA,TENENCIA,ETC.)",
                'center_id' => 14,
                'outgo_type' => "VARIABLE",
                'expense_type' => "GASTO",
                'product_type' => "SERVICIO",
