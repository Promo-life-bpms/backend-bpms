...
class CreateReturnMoneyFromEventualitiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('return_money_from_eventualities', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('return_money_from_eventualities');
    }
}
