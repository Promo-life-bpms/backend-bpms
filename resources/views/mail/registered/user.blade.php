...
<head>
    ...
    <title>Bienvenida al sistema BPMS</title>
    <style>
        /* Estilos generales */
        body {
...
<body>
    <div class="container">
        <div class="inner-container">
            ...
            <hr>
            <p>
                Si tienes problemas con el botón "Inicia sesión", haz click en el siguiente enlace: <a href="{{$data['url']}}">{{$data['url']}}</a>
            </p>
